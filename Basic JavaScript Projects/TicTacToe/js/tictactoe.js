...
function placeXOrO(squareNumber)    {
    ...
    function computersTurn()    {
        ...
        while(!success) {
            ...
            // If the random mnumber evaluated returns true, the square hasn't been selected yet.
...
function checkWinConditions()   {
    ...
    // O 0, 3, 6 condition.
    else if (arrayIncludes('0O', '3O', '6O')) ( drawWinLine(50, 508, 558, 508)  )
    // O 1, 4, 7 condition.
...
function arrayIncludes(squareA, squareB, squareC)   {
        ...
        // returned an our else if condition executes the drawWinLine function.
...
// This function makes our body element temporarilty unclickable.
...
// This line accesses our html canvas element.
    ...
    // This indicates where the start of a line's X-axis is.
    let x1 = coordX1,
...
// This function interacts with the canvas.
    ...
    // This function clears our canvas after our wine line is drawn.
    function clear()    {
